...
```bash cURL
curl https://api.billing.upag.io/v1/subscriptions/sub_abc123xyz/scheduled-changes \
...
```bash cURL
curl -X DELETE https://api.billing.upag.io/v1/subscriptions/sub_abc123xyz/scheduled-changes/sc_abc123xyz \
  -H "Authorization: Bearer {token}"
```
