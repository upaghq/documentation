...
Referência do objeto em `data`: [Payload Subscription](./payload-subscription).
...
Referência do objeto em `data`: [Payload Payment](./payload-payment).
...
Referência do objeto em `data`: [Payload Invoice](./payload-invoice).
